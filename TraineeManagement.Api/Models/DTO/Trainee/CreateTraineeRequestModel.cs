...
public class CreateTraineeRequestModel
{
    ...
    public CreateTraineeRequestModel(string? firstName, string? lastName, string? email, string? techstack, TraineeStatus? status)
    {
        FirstName = firstName;
        LastName = lastName;
        Email = email;
